...
(if (re-search-forward "^\\$Id: gsdoc.el,v 1.1 2004/01/14 16:59:44 atai Exp $" nil t) (progn
...
(if (re-search-forward "<!-- $Id: gsdoc.el,v 1.1 2004/01/14 16:59:44 atai Exp $ -->" nil t)
    (progn
    ...
    (progn
      ...
      (insert (concat "\n<!-- $Id: gsdoc.el,v 1.1 2004/01/14 16:59:44 atai Exp $ -->"))
