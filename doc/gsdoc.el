...
(if (re-search-forward "^\\$Id: gsdoc.el,v 1.2 2004/02/14 22:20:03 atai Exp $" nil t) (progn
...
(if (re-search-forward "<!-- $Id: gsdoc.el,v 1.2 2004/02/14 22:20:03 atai Exp $ -->" nil t)
    (progn
    ...
    (progn
      ...
      (insert (concat "\n<!-- $Id: gsdoc.el,v 1.2 2004/02/14 22:20:03 atai Exp $ -->"))
