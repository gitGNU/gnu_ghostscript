...
# $Id: 3way.tcl,v 1.1 2004/01/14 16:59:53 atai Exp $
...
proc filesame {f1 f2} {
	...
	if {[regexp {^([0-9]+)c([0-9]+)$} $l skip first last] &&
	    ...
	    } elseif {[regexp {\$Id: 3way.tcl,v 1.1 2004/01/14 16:59:53 atai Exp $a]} {
		if {[regexp {\$Id: 3way.tcl,v 1.1 2004/01/14 16:59:53 atai Exp $c]} {continue}
	    }
	}
	set same 0
	break
